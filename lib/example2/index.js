var express = require('express'),
    ...
    MemcachedCache = require('@forgerock/openam-agent-cache-memcached').MemcachedCache,
    CouchDBCache = require('@forgerock/openam-agent-cache-couchdb').CouchDBCache,
    RedisCache = require('@forgerock/openam-agent-cache-redis').RedisCache,
    MongoCache = require('@forgerock/openam-agent-cache-mongodb').MongoCache,
...
var pkg = require('@forgerock/openam-agent/package.json'),
    app = express(),
...
var server = app.listen(3000, function () {
    console.log('Example 2 started on port %s', server.address().port);
});
